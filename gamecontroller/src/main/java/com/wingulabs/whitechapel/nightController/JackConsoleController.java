...
/**
 * control jack using user's input from console.
 * @author ant
 *
 */
public class JackConsoleController extends AbstractJackController {
    ...
    protected final String jackMove() {
        ...
        System.out.println("Jack currently has " + jack.getCoachAlley()[0] + " coach tokens and "
        ...
        while (!check) {
            if (choice == 2 && jack.getCoachAlley()[0] == 0) {
                System.out.println("Jack has used all of the coach token " + " please select another move.");
                choice = ConsoleUtility.getIndexSelection(1, 3);
            } else if (choice == 3 && jack.getCoachAlley()[1] == 0) {
                System.out.println("Jack has used all of the alley token " + " please select another move.");
                choice = ConsoleUtility.getIndexSelection(1, 3);
            } else {
                check = true;
            }
