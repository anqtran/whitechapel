...
public interface DetectiveMoveResult {
	...
	class SearchCluesResult implements DetectiveMoveResult {
		 ...
		 * @param clueAnswers The answers for each vertex that was searched in
		 * the move.
		 */
		public SearchCluesResult(final DetectiveMove.SearchClues move,
				final Map<String, Answer> clueAnswers) {
			this.move = move;
	...
	class AttemptArrestResult implements DetectiveMoveResult {
		 ...
		 * Initializes fields.
		 * @param move The move that was made.
		 * @param answer True if the arrest was successful, false otherwise.
		 */
		public AttemptArrestResult(final DetectiveMove.AttemptArrest move,
