...
public class Detectives {
     ...
     */
    public Detectives() {
        detectives = new Detective[] {new Detective(DetectiveColor.BLUE), new Detective(DetectiveColor.BROWN),
            new Detective(DetectiveColor.GREEN), new Detective(DetectiveColor.RED), new Detective(DetectiveColor.YELLOW) };
    }
    ...
    /**
     * Returns the Detective that's currently at the given location or null if
     * no detectives are at that location.
     * 
     * @param vertex
     *            The location to check.
     * @return the Detective that's currently at the given location or null if
     *         no detectives are at that location.
     */
