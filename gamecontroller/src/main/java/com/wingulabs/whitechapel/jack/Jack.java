...
public class Jack {
    /**
     * Special tokens jack has in each night. The first index is coach, second
     * is alley. These two numbers change in every night.
     */
    private int[] coachAlley;
    /**
     * List of past move of Jack not including current location. Used to the
     * search clues of detectives.
     */
    ...
    /**
     * Set current location to new location. Add the previous location to past
     * move.
     * 
     * @param currentLocation
     *            new Jack location.
