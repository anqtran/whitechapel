...
public class MyGameEngine implements GameEngine {
	...
	@Override
	public final String getMove(final String pVertex,final Detectives loc,
								final DetectivesEngineUtility dUtility, final int detectiveIndex) throws IOException {
