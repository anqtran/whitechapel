...
public class GraphUtility {
     ...
     */
    public static Set<String> getAdjacentVertex(final String root, final SimpleGraph<String, Edge> myGraph) {
    ...
    private static Set<String> whereCanJackGoHelper(String src, Set<String> visitedVertices, Detectives detectives,
            GameBoard gb) {
