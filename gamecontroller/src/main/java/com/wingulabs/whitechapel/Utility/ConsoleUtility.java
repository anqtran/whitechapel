...
/**
 * Utilities to support the input through console.
 * @author ant
 *
 */
public class ConsoleUtility {
    ...
    /**
     * Pick a specific location from a given list.
     * @param possibleLocation the list of possible locations.
    ...
    /**
     * Print all the String in a lists
    ...
    /**
     * Get a number of selection from the user.
