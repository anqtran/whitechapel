...
public class Edge extends DefaultEdge {
     ...
     * 
     * @param sourceVertex
     *            The vertex for which to return the connected / adjacent
     *            vertex.
    ...
    public final String getConnectedVertex(final String sourceVertex) {
        if (super.getSource().equals(sourceVertex))
            ...
            throw new RuntimeException("Vertex: " + sourceVertex + " is not a member of edge: " + this);
    }
    ...
    public final String getTargetVertex(final String sourceVertex) {
        if (super.getSource().equals(sourceVertex))
            ...
            throw new RuntimeException("Vertex: " + sourceVertex + " is not a source of edge: " + this);
    }
}
