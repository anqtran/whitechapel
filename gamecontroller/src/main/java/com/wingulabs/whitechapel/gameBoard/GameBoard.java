...
public class GameBoard {
     ...
     */
    public static final String CIRCLE_TO_CIRCLE_FILEPATH = "circle_to_circle_edges.txt";
     ...
     */
    public static final String ALLEY_CIRCLE_TO_CIRCLE_FILEPATH = "alley_edges.txt";

    /**
     * The graph containing all edges (to/from squares and circles)
     */
    private final SimpleGraph<String, Edge> completeGraph = new SimpleGraph<>(Edge.class);

    /**
     * The graph containing square-to-square edges.
     */
    private final SimpleGraph<String, Edge> squareGraph = new SimpleGraph<>(Edge.class);

    /**
     * The graph containing square-to-circle edges.
     */
    private final SimpleGraph<String, Edge> mixedGraph = new SimpleGraph<>(Edge.class);

    /**
     * The graph containing square-to-circle edges.
     */
    private final SimpleGraph<String, Edge> circleToSquareGraph = new SimpleGraph<>(Edge.class);

    /**
     * The graph containing circle-to-circle edges.
     */
    private final SimpleGraph<String, Edge> circleGraph = new SimpleGraph<>(Edge.class);

    /**
     * The graph containing circle-to-circle alley edges.
     */
    private final SimpleGraph<String, Edge> alleyCircleGraph = new SimpleGraph<>(Edge.class);
     ...
     * 
     * @throws IOException
     *             If an error occurs while reading the data files.
     */
    ...
    private void init() throws IOException {
        try (BufferedReader rdr = new BufferedReader(
                new InputStreamReader(getClass().getClassLoader().getResource(PRIMARY_EDGES_FILEPATH).openStream()))) {
        ...
        try (BufferedReader rdr = new BufferedReader(new InputStreamReader(
                getClass().getClassLoader().getResource(CIRCLE_TO_CIRCLE_FILEPATH).openStream()))) {
    ...
    private void initAlleyCircleGraph() throws IOException {
        try (BufferedReader rdr = new BufferedReader(new InputStreamReader(
                getClass().getClassLoader().getResource(ALLEY_CIRCLE_TO_CIRCLE_FILEPATH).openStream()))) {
     ...
     *            The file reader
     * @throws IOException
     *             Upon an error occurring when reading the data file.
     */
    private void readAdjacentCircleVerticies(final String sourceVertex, final BufferedReader rdr) throws IOException {
