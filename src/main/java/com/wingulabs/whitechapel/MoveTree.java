...
/**
 * A tree / directed acyclic graph for tracking which paths Jack has
 * potentially made, through circle vertices. The root is a "kill spot".
 * The leaves are the vertices on which Jack might be at the current moment.
 *
...
public abstract class MoveTree extends DirectedAcyclicGraph<Vertex, Edge> {
	 ...
	 * @param destinations The new leaves.
	 */
	public void setLeaves(final Set<Vertex> destinations) {
